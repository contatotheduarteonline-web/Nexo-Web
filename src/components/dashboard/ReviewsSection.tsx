            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-60 overflow-y-auto pr-1 scrollbar-thin">
              {todayReviews.slice(0, 6).map((rev) => (
                <div
                  ...
                  className="flex items-center justify-between rounded-xl border border-[#E5E7EB] bg-[#F8F9FB] p-3.5 text-[13px] transition hover:border-[#F97316]/40 hover:bg-white dark:border-[#1E2638] dark:bg-[#161D2B] cursor-pointer group"
                >
                  <div className="min-w-0 pr-3">
                    <p className="font-semibold text-[#172033] dark:text-white truncate group-hover:text-[#F97316] transition-colors">
                      {rev.topicName}
                    </p>
                  ...
                  <span className="inline-flex items-center rounded-lg bg-orange-50 px-2.5 py-1 text-[12px] font-semibold text-[#F97316] dark:bg-orange-950/40 shrink-0">
                    Revisar &rarr;
                  </span>
                </div>
              ))}
