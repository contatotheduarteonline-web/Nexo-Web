        ...
        <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-12">
          ...
          <div className="relative sm:col-span-6 lg:col-span-6">
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2 pl-8 pr-8 text-xs text-slate-900 placeholder:text-slate-400 focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] dark:border-slate-800 dark:bg-[#0F172A] dark:text-white"
            />
            {searchQuery && (
              <button
                type="button"
          ...
          <div className="relative sm:col-span-3 lg:col-span-3">
            <select
              ...
              className="w-full appearance-none rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 pr-8 text-xs font-semibold text-slate-900 transition focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] dark:border-slate-800 dark:bg-[#0F172A] dark:text-white cursor-pointer truncate"
            >
                ...
                <button
                  ...
                  className={`rounded-lg px-2.5 py-1 text-xs font-semibold transition cursor-pointer ${
                    isSelected
                      ...
                      : "bg-slate-100 text-slate-600 hover:bg-slate-200 dark:bg-[#0F172A] dark:text-slate-400 dark:hover:bg-slate-800"
                  }`}
                >
                  {p.label}
                </button>
        ...
        {periodFilter === "custom" && (
          <div className="flex flex-wrap items-center gap-2 pt-1">
            ...
            <input
              ...
              className="rounded-lg border border-slate-200 bg-slate-50 px-2.5 py-1 text-xs font-medium text-slate-900 dark:border-slate-800 dark:bg-[#0F172A] dark:text-white"
            />
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2 text-xs">
                  {/* Modalidade */}
                  <span className="inline-flex items-center rounded-md bg-slate-100 px-2 py-0.5 text-xs font-semibold text-slate-700 dark:bg-[#0F172A] dark:text-slate-300 border border-slate-200/80 dark:border-slate-800">
                    {session.modality}
                  </span>
