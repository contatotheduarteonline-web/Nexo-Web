    ...
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/60 p-4 sm:p-6 backdrop-blur-xs">
      <div className="w-full max-w-2xl sm:max-w-3xl rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl dark:border-zinc-800 dark:bg-zinc-900 transition-all">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-zinc-100 dark:border-zinc-800">
          ...
          <button
            onClick={onClose}
            className="rounded-lg p-2 text-white hover:bg-zinc-100 hover:text-white dark:hover:bg-zinc-800 dark:hover:text-white transition cursor-pointer"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
            ...
            <div className="flex items-center gap-2">
              ...
              {text.trim() && (
                <button
                  type="button"
                  onClick={() => setText("")}
                  className="text-xs text-white hover:text-red-500 flex items-center gap-1 transition cursor-pointer"
                  title="Limpar texto"
                >
        ...
        <div className="flex items-center justify-end gap-2.5 pt-4 border-t border-zinc-100 dark:border-zinc-800">
          <button
            type="button"
            onClick={onClose}
            className="rounded-xl px-4 py-2.5 text-xs font-semibold text-white hover:bg-zinc-100 dark:text-white dark:hover:bg-zinc-800 transition cursor-pointer"
          >
            Cancelar
          </button>
          <button
